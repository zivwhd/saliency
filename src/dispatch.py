...
def get_mcomp_sal_creator():
    ...
    return MultiCompExpCreator(
        ...
        groups=[
            ...
            dict(c_mask_completeness=1.0, c_completeness=0, c_tv=0.1, c_model=0, c_norm=True, c_activation="sigmoid", c_magnitude=0.15),
            dict(c_mask_completeness=1.0, c_completeness=0, c_tv=0.1, c_model=0, c_norm=True, c_activation="sigmoid", c_magnitude=0.2),
    ])
