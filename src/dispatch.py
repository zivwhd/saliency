...
def get_mcomp3_sal_creator():
    ...
    return MultiCompExpCreator(
        ...
        groups=[
            ...
            dict(c_mask_completeness=1.0, c_completeness=0.1, c_tv=0.15, c_model=0, c_norm=False, c_activation=""),
            dict(c_mask_completeness=1.0, c_completeness=0.1, c_tv=0.1, c_model=0, c_norm=False, c_activation=""), 
            dict(c_mask_completeness=1.0, c_completeness=0.1, c_tv=0.05, c_model=0, c_norm=False, c_activation=""), 
            dict(c_mask_completeness=1.0, c_completeness=0.1, c_tv=0.02, c_model=0, c_norm=False, c_activation=""), 
