...
def get_autoncomp_sal_creator():
    ...
    return CombSaliencyCreator([
        ...
        MProbCompExpCreator(
            desc="SLOCxProb", segsize=[32,56], nmasks=[500,500], c_opt="Adam", lr=0.1, lr_step=45, lr_step_decay=0.9,  
            epochs=501, select_from=None, select_freq=3, select_del=1.0, c_mask_completeness=1.0, c_magnitude=0.01, c_positive=0, 
            c_completeness=0, c_tv=0.1, c_model=0.0, c_norm=False,  c_activation="",
        ),
...
def get_segsloc_sal_creator():
    ...
    #    epochs=501, select_from=None, select_freq=3, select_del=1.0, c_mask_completeness=1.0, c_magnitude=0.0, c_positive=1, 
    #    c_completeness=0, c_tv=0.01, c_model=0.0, c_norm=False,  c_activation="",        
    #)
    ## SegMulti seg_list=[(20,200,0.5),(40,400,0.5),(60,400,0.5) c_magnitude=0.01, c_positive=0, c_completeness=0, c_tv=0.1
    #return SegSlocExpCreator(
    ...
    algo = MultiCompExpCreator(
        ...
        mask_groups={
            ...
            #f"SegsMid":{-20:300, -40:300, -60:400}, f"SegsLow":{-20:400, -40:300, -60:300}, 
            #f"SegsHigh":{-20:200, -40:400, -60:400},
            #f"SqSegsHighDb":{-20:200, -40:400, -60:400, 32:500, 56:500},
            #f"SqSegsHigh":{-20:100, -40:200, -60:200, 32:250, 56:250},
            f"SegsHighDb":{-20:400, -40:800, -60:800},
            f"SqDb":{32:1000, 56:1000},
        },
        pprob=[None],
        baselines = [ZeroBaseline()],
...
def get_ckshap_sal_creator():    
    return CombSaliencyCreator([
        ...
        GTKShapCreator(n_samples=5, n_segments=40, actual=True),
...
def get_abl2_sal_creator(nmasks=1000):
    ...
    runs = [
        MulCompExpCreator(
            desc="MinRomp32", segsize=[[32,56]]*10, mode=["min", "mean","median","prod"], nmasks=[500,500], c_opt="Adam", lr=0.1, lr_step=45, lr_step_decay=0.9,  
            epochs=501, select_from=None, select_freq=3, select_del=1.0, c_mask_completeness=1.0, c_magnitude=0.01,
            c_completeness=0, c_tv=0.1, c_model=0.0, c_norm=False,  c_activation="",
        )
    ]
...
def get_obench_sal_creator():
    return CombSaliencyCreator([
        AutoCompExpCreator(
            desc="AutoCompSMix32x56", segsize=[32,56], nmasks=[500,500], c_opt="Adam", lr=0.1, lr_step=45, lr_step_decay=0.9,  
            epochs=501, select_from=None, select_freq=3, select_del=1.0, c_mask_completeness=1.0, c_magnitude=0.01, c_positive=0, 
            c_completeness=0, c_tv=0.1, c_model=0.0, c_norm=False,  c_activation="", batch_size=128,
        ),        
        LTXSaliencyCreator(),        
