...
BASE_PATH = "resultsA/vgg16/saliency/"
def stats():
    ...
    for path in base_paths:
        ...
        for mdl in ["NT","RT"]:
            other_path = f"resultsA/vgg16{mdl}/saliency/MWCompZr_500_40_300b_msk1.0_tv0.1_mgn0.01_0/{image_name}"
